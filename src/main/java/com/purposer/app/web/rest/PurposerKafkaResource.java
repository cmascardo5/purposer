...
@RestController
@RequestMapping("/api/purposer-kafka")
public class PurposerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PurposerKafkaResource.class);
    ...
    public PurposerKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
